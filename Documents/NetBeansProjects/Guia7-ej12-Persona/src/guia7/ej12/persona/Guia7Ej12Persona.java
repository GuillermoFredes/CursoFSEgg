...
public class Guia7Ej12Persona {
    ...
    public static void main(String[] args) {
        ...
        per1.crearPersona(p1, p1);
        per1.calcularEdad(p1);
        
        
        System.out.println("Ingrese una edad para comparar");
        
        System.out.println(per1.menorQue(p1.getNacimiento().getYear(), leer.nextInt()));
        
        per1.mostrarPersona(p1, p1);
